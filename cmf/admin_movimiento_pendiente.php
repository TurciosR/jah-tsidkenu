              ...
              <div class='row' id='form_invent_inicial'>
                ...
                <div class="col-lg-3">
                  <div class='form-group has-info'><label>Origen</label>
                    ...
                    <?php
                    $sql = _query("SELECT * FROM ubicacion WHERE id_sucursal='$id_sucursal' AND bodega!=1 ORDER BY descripcion ASC");
...
function traerpaginador()
{
  ...
  if(isset($_POST['page']))
  {
    ...
    $sqlParcial=get_sql($start,$limit,$producto_buscar,$origen,$sortBy);
    //get number of rows
    $sql1="SELECT COUNT(*) as numRecords  FROM producto AS pr, movimiento_producto_pendiente AS su";
...
function reponer()
{
    ...
    _commit();
		$xdatos['typeinfo']="Success";
		$xdatos['msj']="Registro ingresado correctamente";
	}
	else {
		# code...
		_rollback();
