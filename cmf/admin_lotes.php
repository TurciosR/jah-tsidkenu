...
function traerlotes()
{
  ...
  $sql=_query("SELECT lote.*,producto.descripcion FROM lote JOIN producto ON producto.id_producto=lote.id_producto WHERE lote.id_producto=$id_producto AND lote.estado='VIGENTE' AND lote.cantidad>0");
  echo _error();
