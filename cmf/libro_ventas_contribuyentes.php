...
$municipio = $row3["nombre_municipio"];
   ...
   $pdf->SetXY($set_x+28, $set_y+11);
    ...
    $pdf->SetX($set_x);
    $pdf->Cell(15,4,utf8_decode("GRABADAS"),"BLR",0,'C');
    $set_x = $pdf-> GetX();
    $pdf->SetXY($set_x,$pdf->GetY()-3);
    ...
    $pdf->SetX($set_x);
    $pdf->Cell(13,4,utf8_decode("GRABADAS"),"BLR",0,'C');
    $set_x = $pdf-> GetX();
    $pdf->SetXY($set_x,$pdf->GetY()-3);
   ...
   $pdf->SetXY($set_x+28, $set_y+11);
    ...
    $pdf->Cell(220,5,utf8_decode(ucwords(Minu("Depto. ".utf8_decode($departamento)))),0,1,'C');
    $pdf->SetXY($set_x+98, $set_y+5);
    $pdf->MultiCell(85,3.5,str_replace(" Y ", " y ",ucwords(utf8_decode(Minu($direccion)))).", San Miguel",0,'C',0);
    $pdf->SetXY($set_x+28, $set_y+14);
    $pdf->Cell(220,5,Mayu("PBX: ".$telefono1." / ".$telefono2),0,1,'C');
    $plus = 0;
    $pdf->SetXY($set_x+28, $set_y+17-$plus);
...
ob_clean();
$pdf->Output("libro_ventas_a_contribuyente.pdf","I");
