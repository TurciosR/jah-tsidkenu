						...
						<div class="ibox-content">
							<form name="formulario" id="formulario">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group has-info single-line">
											<label>Vencimiento MESES</label>
											<select style="width:100%;" class="vence select" id="vence" name="vence">
...
function insertar()
{
	...
	$sql_exis=_query("SELECT id_proveedor FROM nombre='$nombre_proveedor' AND  proveedor WHERE nit ='$nit' AND id_sucursal='$id_sucursal'");
