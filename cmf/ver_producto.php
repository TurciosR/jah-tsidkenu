...
$sql="SELECT p.descripcion, p.barcode, p.estado, p.imagen, pv.nombre, c.nombre_cat FROM producto AS p, proveedor as pv, categoria as c WHERE p.id_proveedor=pv.id_proveedor AND p.id_categoria=c.id_categoria AND  p.id_producto='$id_producto'";
$result = _query( $sql);
          ...
          <table	class="table table-bordered table-striped" id="tableview">
            ...
            <tbody>
              <?php
                  ...
                  $sql_p = _query("SELECT pp.precio, pp.costo, pp.descripcion,pp.id_presentacion, p.nombre FROM presentacion_producto as pp, presentacion as p WHERE pp.presentacion=p.id_presentacion AND pp.id_producto = '$id_producto' AND pp.id_sucursal=$_SESSION[id_sucursal]");
