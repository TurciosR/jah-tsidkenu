...
$columns = array(
  ...
  'formatter' => function ($id_traslado, $row) {
      ...
      if ($id_sucursal_envia==$id_sucursal) {
        $menudrop.= "<li><a data-toggle='modal'  href='imprimir_traslado.php?id_traslado=".$id_traslado."' data-target='#viewModal' data-refresh='true'><i class=\"fa fa-print\"></i> Imprimir Traslado</a></li>";
      }
