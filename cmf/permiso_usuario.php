								...
								<div class="row">
									...
									<div class="form-group col-lg-3">
										<div class="form-group">
											<div class='checkbox i-checks'><br>
												<label id='frentex'>
													<input type='checkbox' id='preci' name='preci' <?php if($precios) echo " checked "; ?>> <strong> Todos los precios</strong>
												</label>
											</div>
											<input type='hidden'  id='precio' name='precio' <?php if($precios) echo " value='1' "; else echo " value='0' "; ?>>
										</div>
									</div>
