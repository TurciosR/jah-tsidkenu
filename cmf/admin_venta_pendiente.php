	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='venta1_1.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar factura</a>";
				echo "</div>";
				//permiso del script
...
<?php
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_venta_pendiente.js'></script>";
		} //permiso del script
else {
