...
$joinQuery=" FROM producto as pr JOIN proveedor as p ON p.id_proveedor=pr.id_proveedor LEFT JOIN categoria as cat ON (pr.id_categoria=cat.id_categoria)";
$extraWhere="";
...
$columns = array(
  ...
  array( 'db' => '`pr`.`composicion`',   'dt' => 3, 'field' => 'composicion'),
