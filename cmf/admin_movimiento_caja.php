...
function initial()
{
	...
	$sql_movimientos = _query("SELECT mov_caja.*,movimiento_caja_tipo.tipo FROM mov_caja LEFT JOIN movimiento_caja_tipo ON movimiento_caja_tipo.id_tipo=mov_caja.id_tipo WHERE id_sucursal = '$id_sucursal' AND fecha BETWEEN '$fecha_1' AND '$fecha_2' ORDER BY id_movimiento DESC");
...
function search()
{
	...
	$sql_movimientos = _query("SELECT mov_caja.*,movimiento_caja_tipo.tipo FROM mov_caja LEFT JOIN movimiento_caja_tipo ON movimiento_caja_tipo.id_tipo=mov_caja.id_tipo WHERE id_sucursal = '$id_sucursal' AND fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY id_movimiento DESC");
	$cuenta = _num_rows($sql_movimientos);
