...
function initial()
{
  ...
  $sql0="SELECT credito.fecha,credito.numero_doc,credito.total,credito.abono,credito.saldo, cliente.nombre FROM credito LEFT JOIN cliente ON cliente.id_cliente=credito.id_cliente WHERE credito.id_credito=$id_credito";
  $result = _query($sql0);
