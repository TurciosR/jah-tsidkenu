...
function _update($table_name, $form_data, $where_clause='')
{
    ...
    $table = $table_name;
    $exculdes = array('presentacion', 'proveedor', 'categoria', 'producto', 'presentacion_producto', 'presentacion_producto_precio', 'traslado', 'traslado_detalle','traslado_detalle_recibido', 'log_cambio_local', 'log_cambio_detalle_local','traslado_g','traslado_detalle_g','log_update_local','mail','sms',' pedido_prov','pedido_prov_detalle');
