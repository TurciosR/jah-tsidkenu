...
// Page setup
$_PAGE = array ();
$title='Administrar Facturas Pendientes';
$_PAGE ['title'] = $title;
$_PAGE ['links'] = null;
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<?php
				/*$filename='preventa.php';
				$link=permission_usr($id_user,$filename);
				echo "<div class='ibox-title'>";
				if ($link!='NOT' || $admin=='1' )
				echo "<a href='preventa.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Preventa</a>";
				echo "</div>";*/
				//permiso del script
		...
		<?php
		include("footer.php");
		echo" <script type='text/javascript' src='js/funciones/funciones_pendiente_rangos.js'></script>";
	} //permiso del script
	else {
