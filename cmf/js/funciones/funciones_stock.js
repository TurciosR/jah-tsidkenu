$(document).ready(function() {
  $(".select").select2();
  $('#keywords, #barcode,#composicion').on('keyup', function(event) {
    searchFilter();
  });
  $("#ubicacion").change(function(event) {
    searchFilter();
  });
  $("#composicion").change(function(event) {
    searchFilter();
  });
...
function searchFilter(page_num)
{
  ...
  getData(keywords, id_ubicacion, barcode, page_num,composicion)
}
function getData(keywords, id_ubicacion, barcode, page_num,composicion) {
