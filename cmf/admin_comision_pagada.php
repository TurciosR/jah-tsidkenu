...
function initial()
{
	...
	<div class="wrapper wrapper-content  animated fadeInRight">
		<div class="row" id="row1">
								...
								<table class="table table-striped table-bordered table-hover" id="editable2">
									<thead>
										<tr>
											...
											<th class="col-lg-1 text-primary font-bold">Comisión</th>
											<th class="col-lg-1 text-primary font-bold">Fecha P</th>
			...
			<?php
			include("footer.php");
			echo" <script type='text/javascript' src='js/funciones/funciones_comision_pagada.js'></script>";
		} //permiso del script
		else {
