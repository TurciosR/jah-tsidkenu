...
function initial()
{
  ...
  <div class="gray-bg">
                ...
                <div class="ibox-content">
                  ...
                  <div class="row focuss"><br>
                    ...
                    <div class="col-md-7"><br>
                      ...
                      if ($link!='NOT' || $admin=='1' ){
                        echo "
                        <a id='xa' data-toggle='modal' href='agregar_ingreso_caja_v.php'  style='margin-right:1%;'  data-target='#viewModal2' data-refresh='true' class='btn btn-sm btn-warning pull-right'><i class='fa fa-plus icon-large'></i> F10 Ingreso</a>
                        ";
                      }
                      ...
                      if ($link!='NOT' || $admin=='1' ){
                        echo "
                        <a id='xb' data-toggle='modal' href='agregar_salida_caja_v.php' style='margin-right:1%;' data-target='#salidaModal' data-refresh='true' class='btn btn-sm btn-danger pull-right'><i class='fa fa-minus icon-large'></i> F9 Vale</a>
                        ";
                      }
                      ?>
                      <a data-toggle='modal' href='agregar_servicio.php'  style='margin-right:1%;'  data-target='#viewModal2' data-refresh='true' class='btn btn-sm btn-warning pull-right'><i class='fa fa-medkit icon-large'></i> Servicio</a>
                    </div>
                  </div>
                  <div class="row">
    ...
    include_once("footer.php");
    $a = rand(1,9999);
    echo "<script src='js/funciones/venta.js?t$a=$a'></script>";
  ...
  if($count_fact > 0)
  {
    ...
    for ($i=0;$i<$count_fact_det;$i++) {
      ...
      while ($rowx=_fetch_array($sql_ss)) {
        ...
        $uni = uniqid();
        $lista.= "<tr class='row100 head $uni'>";
        ...
        $lista.= "<td hidden class='cell100 column10 text-success' id='cant_stock'>".$existencias."</td>";
        $lista.= "<td class='cell100 column10 text-success' id='cant_perpre'>".round($existencias/$unidadq,2)."</td>";
        ...
        $lista.= "<td class='cell100 column10  text-center'><input id='delprod' type='button' class='btn btn-danger fa Delete'  value='&#xf1f8;'>"."<a id='xb' data-toggle='modal' href='unlock.php?u=$uni' style='margin-right:1%;' data-target='#viewModal2' data-refresh='true' class='btn btn-primary fa'><i class='fa fa-lock'></i></a>"."</td>";
        $lista.= "</tr>";
      }
      $select_vendedor="";
      $sqlemp=_query("SELECT id_empleado, nombre FROM empleado WHERE id_sucursal='$id_sucursal' AND id_tipo_empleado=2");
