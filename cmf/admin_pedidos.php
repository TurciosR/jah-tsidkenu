...
$sql="SELECT pedido.*, cliente.nombre
FROM pedido, cliente
WHERE pedido.id_cliente=cliente.id_cliente
AND pedido.id_sucursal='$id_sucur'
ORDER BY 'PENDIENTE'";
...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<?php	if ($links!='NOT' || $admin=='1' ) {
					...
					$filename='agregar_pedido.php';
					$link=permission_usr($id_user,$filename);
					if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_pedido.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar pedido</a>";
					echo "</div>";
					?>
							...
							<table class="table table-striped table-bordered table-hover" id="editable2">
								<thead>
									<tr>
										...
										<th class="col-lg-1">Fecha P.</th>
										<th class="col-lg-1">Fecha E.</th>
										<th class="col-lg-2">Lugar Entrega</th>
		...
		<?php
		include ("footer.php");
		echo" <script type='text/javascript' src='js/funciones/funciones_pedido.js'></script>";
	} //permiso del script
	else {
