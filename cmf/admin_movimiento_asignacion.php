...
<div class="wrapper wrapper-content  animated fadeInRight">
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($links!='NOT' || $admin=='1') {
					...
					$filename='agregar_asignacion.php';
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <select class="select" style="width:100%" id="pro" name="pro">
                  <option selected value="gen">GENERAL</option>
                  <option value="ing">INGRESOS A INVENTARIO</option>
                  <option value="des">DESCARGOS DE INVENTARIO</option>
                  <option value="com">COMPRAS</option>
                  <option value="asig">ASIGNACIONES</option>
                  <option value="trans">TRANSFERENCIAS</option>
                  <option value="ajus">AJUSTE</option>
                </select>
		...
		<?php
        include("footer.php");
                    echo" <script type='text/javascript' src='js/funciones/funciones_movimiento_asignacion.js'></script>";
                } else {
