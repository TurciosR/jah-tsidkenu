      ...
      while ($row=_fetch_array($sql)) {
       ...
       if ($nrowstik>0) {
        ...
        if ($rowt2['minimo']!=""&&$rowt2['maximo']!="") {
          ...
          $pdf->Cell(10,5,utf8_decode("CF"),0,0,'C');
          ...
          if ($c==44&&$pa==1) {
            ...
            $pdf->Cell(216,6,$direccion,0,1,'C');
            $pdf->SetXY($set_x, $set_y+11);
            $pdf->Cell(216,6,$telefonos,0,1,'C');
            $pdf->SetXY($set_x, $set_y+16);
            $pdf->Cell(216,6,"NIT: ".$nit." NRC: ".$nrc,0,1,'C');
        ...
        while ($rnc=_fetch_array($sql_nc)) {
          ...
          if ($nrowstik>0) {
            ...
            if ($rowt2['minimo']!=""&&$rowt2['maximo']!="") {
                  # code...
              $pdf->Cell(15,5,utf8_decode(ED($row['fecha'])),0,0,'C');
              $pdf->Cell(10,5,utf8_decode("TK"),0,0,'C');
