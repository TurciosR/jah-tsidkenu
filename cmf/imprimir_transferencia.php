...
<div class="modal-body">
	...
	<div class="modal-footer">
		<?php
		echo "<button type='button' id_movimiento='$id_movimiento' class='btn btn-primary imprimir_transferencia' data-dismiss='modal'><i class='fa fa-print'></i> Imprimir</button>
