...
function initial()
{
  ...
  <div class="wrapper wrapper-content  animated fadeInRight">
                      ...
                      <div class="widget-header">
                        ...
                        <div class="widget-content">
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                <input type="text" id="composicion" class='form-control' placeholder="Composicion">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                          ...
                          <table class="table table-bordered" id='loadtable'>
                            <thead>
                              <tr>
                                ...
                                <th class="text-success col-lg-1">Composicion</th>
    ...
    echo "<script src='js/funciones/funciones_stock.js?id=".rand(0,9999)."'></script>";
  }
  function traerdatos()
  {
    ...
    estante.descripcion AS estante, posicion.posicion,pr.composicion
    ...
    $sqlParcial= get_sql($start,$limit,$keywords,$sortBy, $id_ubicacion, $barcode,$composicion);
    ...
    if ($num_rows > 0)
    {
      while ($row = _fetch_array($query))
      {
        ...
        $sql_pres = _query("SELECT pp.*, p.nombre as descripcion_pr FROM presentacion_producto as pp, presentacion as p WHERE pp.presentacion=p.id_presentacion AND pp.id_producto='$id_producto' AND pp.id_sucursal=$_SESSION[id_sucursal] ORDER BY pp.unidad DESC");
        ...
        <tr>
          ...
          <td rowspan="<?php echo $npres; ?>" style="vertical-align:middle;"><?php echo $composicion; ?></td>
    ...
    function get_sql($start,$limit,$keywords,$sortBy,$id_ubicacion,$barcode,$composicion)
    {
      $andSQL='';
      $id_sucursal= $_SESSION['id_sucursal'];
