    ...
    <div class="col-lg-12">
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success"><b><i class="mdi mdi-plus"></i> Actualizar Trabajo</b></h3>
        </div>
              ...
              if ($row_ap->id_usuario == $id_usuario) : ?>
                <form id="form_edit" novalidate>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        <label for="cliente">Agregar Nuevo</label>
                      ...
                      <div class="form-group">
                        <select data-parsley-trigger="change" style="width:100%" required class="select2" id="sucursal" name="sucursal">
                          <?php foreach ($sucursal as $key) : ?>
                            <option <?php if ($id_sucursal == $key->id_sucursal) {
                                      echo "selected";
                                    } ?> value="<?= $key->id_sucursal ?>"><?= $key->nombre . " " . $key->direccion ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea name="concepto" id="concepto" style="width:100%" rows="3" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"'><?= $row->concepto ?></textarea>
                      </div>
                    </div>
                  </div>
