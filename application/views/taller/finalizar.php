    ...
    <div class="col-lg-12">
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success"><b><i class="mdi mdi-plus"></i> Facturar trabajo de taller</b></h3>
        </div>
            ...
            if ($row_ap->vigente == 1) :
              if ($row_ap->id_usuario == $id_usuario) : ?>
                <form id="form_fin" novalidate>
                  ...
                  <input type="hidden" id="concepto" name="concepto" value="<?= $row->concepto ?>">
                  ...
                  <div class="row">
                        ...
                        <?php if ($row_clientes != NULL) : ?>
                          <select class="form-group select usage clientes" name="client" id="client">
                            ...
                            <?php foreach ($row_clientes as $rc) : ?>
                              <option value="<?= $rc->id_cliente ?>" <?php if ($rc->id_cliente == $row->id_cliente) echo "selected"; ?>>
                                <?= $rc->nombre ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                      <label for="fecha">Encargado(s)<span class="text-danger">*</span></label>
                        <input class="form-control" list="lista_encargados" name="encargado" required>
                        <datalist id="lista_encargados">
                          <option value="Encargado 1">
                          <option value="Encargado 2">
                        </datalist>
                      </div>
                    </div>
                    <div class="col-lg-2">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea style="width:100%" rows="3" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' disabled><?= $row->concepto ?></textarea>
                      </div>
                    </div>
                  </div>
