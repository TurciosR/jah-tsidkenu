                          ...
                          foreach ($detalleAbonos as $arrDetalle) {
                            ...
                            ?>
                              <tr>
                                ...
                                <td class='text-center'><a class='btn btn-primary update_tr' monto="<?=$arrDetalle->abono; ?>" saldo="<?=$arrDetalle->saldo_total; ?>" abono="<?=$arrDetalle->abono_total; ?>" cuenta="<?=$arrDetalle->id_cuentas_por_cobrar; ?>"  id="<?=$arrDetalle->id_abono; ?>" style='color: white'><i class='mdi mdi-folder-upload'></i></a></td>
                                <td class='text-center'><a class='btn btn-danger delete_tr' monto="<?=$arrDetalle->abono; ?>" saldo="<?=$arrDetalle->saldo_total; ?>" abono="<?=$arrDetalle->abono_total; ?>" cuenta="<?=$arrDetalle->id_cuentas_por_cobrar; ?>"  id="<?=$arrDetalle->id_abono; ?>" style='color: white'><i class='mdi mdi-trash-can'></i></a></td>
                              </tr>
                            <?php
                          }
                        }
