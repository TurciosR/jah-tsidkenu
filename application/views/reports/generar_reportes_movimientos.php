						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group single-line">
									...
									<select data-parsley-trigger="change" style="width:100%" required class="select2" id="selectMovimientos" name="selectMovimientos">
							...
							<div class="col-lg-2">
                                ...
                                <input readonly type="text" class="form-control datepicker fechaInicio" name="" value="<?="01".date("-m-Y")?>">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                            ...
                            <div class="form-actions col-lg-2">
                                ...
                                <button type="button" id="generarReporteMovimientos" name="generarReporteMovimientos" class="btn btn-success m-t-n-xs pull-right" style="width:100%;"><i class="mdi mdi-content-save"></i>
                                Generar Kardex
                                </button>
                            </div>
						</div>
