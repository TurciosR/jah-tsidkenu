...
class ReporteRiedR extends FPDF {
  ...
  public function Header()
  {
    ...
    $this->Cell(205,5,"RESUMEN ".utf8_decode(mb_strtoupper($this->ary['empresa']))." DEL DIA ".$this->ary['desde']." HASTA EL ".$this->ary['hasta'],0,1,'C',0);
    $this->Ln(5);
  }
