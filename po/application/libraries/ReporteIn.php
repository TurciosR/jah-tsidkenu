...
class ReporteIn extends FPDF {
  ...
  public function Header()
  {
    ...
    $this->Cell(205,5,"RESUMEN ".utf8_decode(mb_strtoupper($this->ary['empresa'])),0,1,'C',0);
    $this->Ln(5);
    $this->Cell(50,5,"CODIGO",1,0,'C',0);
    $this->Cell(50,5,"MARCA",1,0,'C',0);
    $this->Cell(50,5,"CASA",1,0,'C',0);
    $this->Cell(55,5,"EXISTENCIAS",1,1,'C',0);
